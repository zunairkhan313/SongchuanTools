        ...
        >
            ...
            <div className='flex flex-col items-center border-2 rounded'>
                    ...
                    <div className='mt-3 text-center p-2'>
                        <p>Drill Machines <br /> THLAD08101 | Company: <br /> Songchuan | Origin: China <br/> <span className="font-bold" style={{color:"#ff3333"}}>Rs5000</span></p>
            ...
            <div className='flex flex-col items-center border-2 rounded'>
                    ...
                    <div className='mt-3 text-center p-2'>
                        <p>Cutting Tools <br /> THLAD08101 | Company: <br /> Songchuan | Origin: China <br/> <span className="font-bold" style={{color:"#ff3333"}}>Rs5000</span></p>
            ...
            <div className='flex flex-col items-center border-2 rounded'>
                    ...
                    <div className='mt-3 text-center p-2 '>
                        <p>Measuring Tools <br /> THLAD08101 | Company: <br /> Songchuan | Origin: China <br/> <span className="font-bold" style={{color:"#ff3333"}}>Rs5000</span></p>
            ...
            <div className='flex flex-col items-center border-2 rounded'>
                    ...
                    <div className='mt-3 text-center p-2'>
                        <p>Tools Box <br /> THLAD08101 | Company: <br /> Songchuan | Origin: China <br/> <span className="font-bold" style={{color:"#ff3333"}}>Rs5000</span></p>
            ...
            <div className='flex flex-col items-center border-2 rounded'>
                    ...
                    <div className='mt-3 text-center p-2'>
                        <p>Screwdrive Series <br /> THLAD08101 | Company: <br /> Songchuan | Origin: China <br/> <span className="font-bold" style={{color:"#ff3333"}}>Rs5000</span></p>
            ...
            <div className='flex flex-col items-center border-2 rounded'>
                    ...
                    <div className='mt-3 text-center p-2'>
                        <p>Sockets Series<br /> THLAD08101 | Company: <br /> Songchuan | Origin: China <br/> <span className="font-bold" style={{color:"#ff3333"}}>Rs5000</span></p>
            ...
            <div className='flex flex-col items-center border-2 rounded'>
                    ...
                    <div className='mt-3 text-center p-2'>
                        <p>Tools Set<br /> THLAD08101 | Company: <br /> Songchuan | Origin: China <br/> <span className="font-bold" style={{color:"#ff3333"}}>Rs5000</span></p>
